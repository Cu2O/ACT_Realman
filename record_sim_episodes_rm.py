...
from scripted_policy_rm import PickAndTransferPolicy2
...
def main(args):
    ...
    elif task_name == 'sim_grasp_cube_ur':
        policy_cls = PickAndTransferPolicy2
    else:
    ...
    for episode_idx in range(num_episodes):
        ...
        env = make_ee_sim_env_rm(task_name)
        ts = env.reset()
        episode = [ts]
